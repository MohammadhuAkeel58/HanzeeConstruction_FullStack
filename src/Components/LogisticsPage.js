...
function LogisticsPage({  selectedItemsLogistic, setSelectedItemsLogistic, totalPriceLogistic, setTotalPriceLogistic })
{
    ...
    return (
        <div className='w-full h-full py-[6rem] px-5'>
            ...
            {view ? <AddStockpage handleView={handleView} /> : <CategoryPage handleView={handleView}  selectedItemsLogistic={selectedItemsLogistic}
