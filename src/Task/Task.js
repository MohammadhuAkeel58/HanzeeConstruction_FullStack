            ...
            <div className='flex w-full h-full flex-wrap'>
                <div className='w-full h-full flex flex-col justify-evenly items-center'>
                    ...
                    <div className='flex w-full justify-evenly'>
                        <button className='btn-1' onClick={() => setOpen({ ...open, view: true })}>
                            View
                        </button>
                        <button className='btn-1 bg-light-gray' onClick={() => setOpen({ ...open, edit: true })}>
                            Edit
                        </button>
                        <button className='btn-1 bg-yellow text-black' onClick={handlePopup}>
                            Delete
                        </button>
                    </div>
                </div>
