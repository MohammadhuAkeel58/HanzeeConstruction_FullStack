    ...
    <Router>
      <div >
        <nav className="fixed font-popins top-0 left-0 right-0 px-10 py-5 flex items-center justify-evenly w-full bg-slateBlue drop-shadow-md z-[5000]">
          <Link to="/" className="text-[1.2rem] font-lg"> NCC Construction</Link>
        ...
        <Routes>
          ...
          <Route path="/stocks" element={<Stock  selectedItemsStock={selectedItemsStock} setSelectedItemsStock={setSelectedItemsStock} totalPriceStock={totalPriceStock} setTotalPriceStock={setTotalPriceStock} />} />


          <Route path="/logistics" element={<Logistics  selectedItemsLogistic={selectedItemsLogistic}
